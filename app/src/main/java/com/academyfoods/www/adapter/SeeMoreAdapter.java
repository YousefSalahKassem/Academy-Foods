...
public class SeeMoreAdapter extends RecyclerView.Adapter<SeeMoreAdapter.mh> {
    List<PopularModel> list;
    Context context;

    public SeeMoreAdapter(List<PopularModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public SeeMoreAdapter.mh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.popular_card,parent,false);
        return new mh(v);    }

    @Override
    public void onBindViewHolder(@NonNull SeeMoreAdapter.mh holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("restaurantName",((SeeMoreActivity)context).name);
                intent.putExtra("restaurantImage",((SeeMoreActivity)context).image);
